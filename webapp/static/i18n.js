...
var I18N = {
  ...
  lbl_difficulty:{ ko: "난이도 — 1(가장 쉬움) ~ 15(가장 어려움)", en: "Difficulty — 1 (easiest) to 15 (hardest)", ja: "難易度 — 1(最も易しい)〜15(最も難しい)", zh: "难度 — 1(最易)到 15(最难)", es: "Dificultad — 1 (fácil) a 15 (difícil)" },
